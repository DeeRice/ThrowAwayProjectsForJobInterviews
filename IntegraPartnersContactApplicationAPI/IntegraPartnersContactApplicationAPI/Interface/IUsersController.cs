...
namespace IntegraPartnersContactApplicationAPI.Interface
{
    public interface IUsersController
    {
        ...
        Task<JsonResult> CreateUser([Bind("UserID,Username,FirstName,LastName,Email,UserStatus,Department")] UsersViewModel userViewModel);
        Task<JsonResult> FindUser(int id);
        Task<JsonResult> EditUser(int id, [Bind("UserID,Username,FirstName,LastName,Email,UserStatus,Department")] UsersViewModel userViewModel);
